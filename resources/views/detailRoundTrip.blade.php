...
<head>
    ...
    <style>
        * {
        ...
        /* ========== HERO SECTION - 3 GAMBAR HORIZONTAL ========== */
        .hero-section {
            width: 100%;
            display: flex;
            overflow: hidden;
...
<body>
    ...
    <div class="container">
        <div class="detail-section">
            <p class="detail-desc">
                Paket Round Trip merupakan paket perjalanan pulang-pergi yang dirancang bagi peserta yang ingin
