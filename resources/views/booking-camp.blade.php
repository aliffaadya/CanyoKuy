                ...
                fetch('/api/bookings', {
                    ...
                    .then(result => {
                        ...
                        if (result.success) {
                            ...
                            const waMessage = `Halo Admin CanyoKuy!%0A%0A*KONFIRMASI PEMBAYARAN DP*%0A%0ANama: ${document.getElementById('inputNama').value}%0AEmail: ${document.getElementById('inputEmail').value}%0AKode Booking: ${result.booking_code}%0ATanggal: ${tanggal}%0ATotal DP: Rp 165.000%0A%0AMohon segera diverifikasi. Terima kasih.`;
